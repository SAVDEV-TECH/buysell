...
export default function MobileBottomNav() {
  ...
  return (
    <div className="md:hidden fixed bottom-0 left-0 right-0 h-16 bg-background dark:bg-slate-900 border-t border-border dark:border-slate-800 flex items-center justify-around z-50 px-2 pb-safe shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)]">
      {navItems.map((item) => {
